...
public class PhotonPlayerProperty
{
    ...
    public static string sex = "sex"; // yes please
    ...
    public static string uniform_type = "uniform_type";//"part_chest_1_skinned_cloth_texture";
    //public static string Nathan = "Nathan";
    //public static string Angry_Guest = "Angry_Guest";
