    ...
    public bool checkObj(string key, PhotonPlayer photonPlayer, int[] viewIDS)
    {
        ...
        foreach (int num3 in viewIDS)
        {
            if ((num3 <= num) || (num3 >= num2))
            {
                ...
                if (!FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                    FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Invalid photon view");
        ...
        switch (key)
        {
            ...
            case "rcasset/bombexplodemain":
                ...
                {
                    if (!(!PhotonNetwork.isMasterClient || FengGameManagerMKII.instance.restartingBomb || FengGameManagerMKII.HasJustJoined))
                    {
                        FengGameManagerMKII.instance.kickPlayerRC(photonPlayer, true, "spawning bomb item (" + key + ").");
                    }
                    if (!FengGameManagerMKII.instance.restartingBomb && FengGameManagerMKII.HasJustJoined && !FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                        FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned bomb:" + key);
                    return false;
                }
            ...
            case "fx/bite":
                ...
                if (!FengGameManagerMKII.instance.restartingTitan && !FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                    FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned titan effects: " + key);
                return false;
            ...
            case "titan_eren":
                ...
                if (!FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                    FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned titan eren: " + key);
                return false;
            ...
            case "hitmeatbig":
                if (!(RCextensions.returnStringFromObject(photonPlayer.customProperties[PhotonPlayerProperty.character]).ToUpper() != "EREN"))
                {
                    if (RCSettings.banEren > 0)
                    {
                        ...
                        if (!FengGameManagerMKII.instance.restartingEren && !FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                            FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned eren effect: " + key);
            ...
            case "fx/boom1_ct_kick":
                ...
                if (!FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                    FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned colossal effect :" + key);
                return false;
            ...
            case "rock":
                ...
                FengGameManagerMKII.instance.kickPlayerRC(photonPlayer, true, "spawning MC item (" + key + ").");
                if (!FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                    FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned rock: " + key);
                return false;
            ...
            case "horse":
                ...
                if (LevelInfo.getInfo(FengGameManagerMKII.level).horse || (RCSettings.horseMode != 0))
                {
                    if (!FengGameManagerMKII.instance.restartingHorse && !FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                        FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned horse: " + key);
                }
                return false;
            ...
            case "titan_ver3.1":
                ...
                if (!PhotonNetwork.isMasterClient)
                {
                    if (FengGameManagerMKII.masterRC && (IN_GAME_MAIN_CAMERA.gamemode != GAMEMODE.BOSS_FIGHT_CT))
                    {
                        ...
                        {
                            if (!FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                                FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned titan: " + key);
                            return false;
                        }
                    }
                    break;
            ...
            case "titan_new_2":
                ...
                {
                    if (!FengGameManagerMKII.instance.InternalIgnore.Contains(photonPlayer))
                        FengGameManagerMKII.instance.InternalIgnorePlayer(photonPlayer, "Spawned illegal item: " + key);
                }
