...
public class CostumeConeveter
{
    ...
    public static void HeroCostumeToLocalData(HeroCostume costume, string slot)
    {
        ...
        PlayerPrefs.SetFloat(slot + PhotonPlayerProperty.hair_color1, 1.0f/*costume.hair_color.r*/);
        PlayerPrefs.SetFloat(slot + PhotonPlayerProperty.hair_color2, 1.0f/*costume.hair_color.g*/);
        PlayerPrefs.SetFloat(slot + PhotonPlayerProperty.hair_color3, 1.0f/*costume.hair_color.b*/);
