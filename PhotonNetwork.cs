...
public static class PhotonNetwork
{
    ...
    public static ExitGames.Client.Photon.Hashtable GetLocalActorProperties2()
    {
        ...
        hashtable[(byte)0xff] = PhotonNetwork.networkingPeer.PlayerName;
        return hashtable;
    }
...
//         //GameObject.Find("MultiplayerManager").GetComponent<FengGameManagerMKII>().name = PhotonNetwork.player.name;
        ...
        bWasJustKicked = true;
//         FengGameManagerMKII.CurrentKick = Environment.TickCount;
//         FengGameManagerMKII.LastKick = FengGameManagerMKII.CurrentKick + 800;
