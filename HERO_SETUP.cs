...
public class HERO_SETUP : MonoBehaviour
{
    ...
    public void create3DMG()
    {
        ...
        {
            //Quaternion Inverseangle = Quaternion.Inverse(this.part_head.transform.rotation);
            this.part_3dmg = (GameObject) UnityEngine.Object.Instantiate(Resources.Load("Character/" + this.myCostume.mesh_3dmg));
            //Transform MaskTransform = this.part_face.transform;/*this.transform.Find("Amarture/Core/Controller_Body/hip/spine/chest/neck/head");*/
            this.part_3dmg.transform.position = /*this.part_head.transform.position + (this.part_head.transform.forward * 1.5f) + (Vector3.up * 0.20f);*/this.mount_3dmg.transform.position;
            this.part_3dmg.transform.rotation =/*Inverseangle;*/this.mount_3dmg.transform.rotation;
            this.part_3dmg.transform.parent = /*this.part_head.transform.parent;*/this.mount_3dmg.transform.parent;
